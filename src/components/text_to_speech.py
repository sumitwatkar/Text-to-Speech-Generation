...
class TTSGeneration():
    def __init__(self, app_config=ttsConfig()) -> None:
        """
        Constructor for TTSGeneration class.
    ...
    def text_to_speech(self, text, accent):
        """
        ...
        try:
            ...
            file_name = f"audio_{CURRENT_TIME_STAMP}.mp3"
            ...
            logger.error(f"Error occurred during text to speech conversion: {e}")
            raise CustomException(e, sys)